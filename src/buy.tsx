    ...
    return (
        <div className='relative'>
            ...
            <h1 className='text-white text-xl opacity-70'>Zeal Real Estate</h1>
                ...
                <img className="w-[50%] sm:w-[30%] lg:w-[15%] h-[50%] md:w-[15%] hidden md:pt-1" src='https://agentplus-s3.s3.eu-west-2.amazonaws.com/discover-agentplus/logos/2022/08/17/34f7a0a9-8d33-4345-93ff-699c5611dfa4.png' alt="" />
